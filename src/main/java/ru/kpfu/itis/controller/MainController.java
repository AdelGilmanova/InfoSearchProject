...
public class MainController extends BaseController {
    ...
    public String search(@RequestParam(required = false) String text,
        ...
        Resource resource = appContext.getResource("/resources/information/invert/");
        ...
        if (words.length == 1) {
            ...
            if (filesList.contains(words[0])) {
                String name = "/resources/information/invert/" + words[0];
        ...
        //если слов много
            ...
            for (int i = 1; i < words.length; i++) {
                if (filesList.contains(words[i])) {
                    String name = "/resources/information/invert/" + words[i];
                    String line = getFileContent(name);
                    String lineData[] = line.split(" ");
    ...
    public Map<String, String> index() throws IOException {
        ...
        ApplicationContext appContext = new ClassPathXmlApplicationContext(new String[]{});
        Resource resource = appContext.getResource("/resources/information/index.txt");
